...
- Please make build directory in ~/Downloads, b-linux for linux and b-boot for u-boot, and use rmake function provided in ~/.scripts/setup-oe.sh to do out-of-tree build.
- to update the kernel, you just need to scp the zImage to /mnt directory in the device and reboot the system. To deploy the dtb file, it also needs to be renamed to sunxi.dtb.
- to update u-boot, please let me know. I will manually update u-boot and return the control to you.

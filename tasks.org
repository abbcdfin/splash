...
** TODO Backport sun6i MIPI DSI controller driver
   :PROPERTIES:
   :PLAN_REF: 2.1
   :DEPENDS: 1.1, 1.2
   :END:
...
** TODO Add DSI output mode to TCON/LCDC
   :PROPERTIES:
   :PLAN_REF: 2.2
   :END:
...
** TODO Extend DE2 driver for DSI output path
   :PROPERTIES:
   :PLAN_REF: 2.3
   :END:
...
** TODO Backport ILI9881C panel driver
   :PROPERTIES:
   :PLAN_REF: 3.1
   :END:
...
** TODO Add display nodes to U-Boot device tree
   :PROPERTIES:
   :PLAN_REF: 3.2
...
** TODO Enable video in board defconfig
   :PROPERTIES:
   :PLAN_REF: 3.3
   :DEPENDS: 3.2
   :END:

...
*Verification*:
- [ ] Kernel log shows: =Skipping panel init (already configured by bootloader)=
- [ ] No visible black screen flash during DRM/KMS takeover
...
With =simplefb= already registered as =fb0=, this requires only two Kconfig lines in
...
|     5 |  5.2 | Panel skip-init (driver + DTS property)  | PLANNED |
|     5 |  5.3 | Framebuffer console (boot msgs on LCD)   | PLANNED |
